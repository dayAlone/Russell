    ...
    render() {
        return <div className='dream'>
            ...
            <div className='text'>
                ...
                <h3 className='center'>Время проведения акции – с 12 октября по 30 декабря.</h3>
                <img src={`/layout/images/line.png`} width='100%' className='text__divider' height='2'/>
                ...
                { this.state.more ? <div className='dream__more'>
                    <p>В акции могут участвовать чеки от покупок, сделанных в период с 12 октября по 29 декабря.</p>
                    ...
                    <h3 className='center'>Розыгрыши проводятся 14, 21 и 30 декабря 2015 года.</h3>
                    <section>
                        ...
                        <div className='text__col text__col--small'>
                            <p>Чтобы принять участие в розыгрыше 30 декабря, вам нужно зарегистрировать ваш чек до 29 декабря включительно.</p>
                        </div>
                    </section>
