...
class Kitchen extends Component {
    ...
    getRulesScreen() {
        return <div className='kitchen__rules'>
            ...
            <p>Всего вы можете сыграть не более 20 раз до начала розыгрыша.</p>
            <p>По итогам игры формируется сумма набранных вами баллов. Это сумма итоговых результатов всех пройденных уровней.</p>
            <p>Если вы поделитесь результатом вашей игры на своей странице в Facebook или ВКонтакте, вам начисляются дополнительные 5 баллов.</p>
            <p>Итоги подводятся один раз в две недели. Рейтинг игрока формируется на основе суммы баллов за все использованные игровые попытки. Выигрывают три участника с наибольшим количеством набранных баллов за 2 недели.</p>
