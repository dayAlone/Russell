...
class Kitchen extends Component {
    ...
    getRulesScreen() {
        return <div className='kitchen__rules'>
            ...
            <p>Если вы поделитесь результатом прохождения теста на своей странице в Facebook или ВКонтакте, вам начисляются дополнительные 5 баллов. Баллы начисляются за каждый результат, которым вы поделились.</p>
    ...
    getStartScreen() {
        return <div>
            ...
            <p>Так что – пришла пора наводить порядок на кухне и подбирать для нее красивые вещи. Вы готовы? Тогда мы приглашаем вас в игру. Мы спрятали на нашей виртуальной кухне разные приборы Russell Hobbs. Вам нужно найти их и собрать.</p>
                        <img src='/layout/images/line.png' alt='' className='kitchen__divider' />
    ...
    getLockedScreen() {
        return <div className='kitchen__placeholder center'>
            <h4>{this.props.user.displayName},<br /> вы использовали все 20 игровых попыток.</h4>
