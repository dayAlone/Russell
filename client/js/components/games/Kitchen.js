...
class Kitchen extends Component {
    ...
    getRulesScreen() {
        return <div className='kitchen__rules'>
            ...
            <p>Время раунда ограничено. После того, как вы соберете всю коллекцию техники или закончится время раунда, игра завершается. Оставшиеся у вас секунды считаются призовыми баллами. Штрафные баллы вычитаются из призовых, после чего формируется итоговый результат раунда.</p>
            <p>У нашей игры 3 уровня сложности. Одна игровая попытка считается использованной, когда игрок проходит все три уровня.</p>
            <p>Всего вы можете сыграть не более 20 раз до начала очередного розыгрыша.</p>
            ...
            <p>Итоги подводятся один раз в 2 недели. Итоговый результат игрока – это сумма баллов за все использованные игровые попытки плюс дополнительные баллы за размещение результатов попыток прохождения в социальных сетях. Выигрывают три участника с наибольшим количеством набранных баллов за 2 недели.</p>
            <p>По итогам 2 недель все результаты обнуляются и начинается следующий 2-х недельный игровой тур.</p>
            <p>Удачи!</p>
            <div className='center'>
    ...
    getStartScreen() {
        return <div>
            ...
            <a href='#' onClick={this.toggleRules(true)}>Правила игры</a><br/><a href="http://164623.selcdn.com/russell/rules/Soberi_kollekciyu_rules.pdf" target="_blank">Условия и правила проведения акции</a>
        </div>
    }
    getResultsScreen() {
