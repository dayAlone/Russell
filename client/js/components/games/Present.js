        ...
        return <div>
            ...
            <div className='present__letter'>
                ...
                <div className='present__letter-col'>
                    ...
                    Намек – на фото.<br/>
                    Мы с моей кухней будем счастливы получить это в подарок :)<br/>
                    Причем, счастья может хватить на всех – зарегистрируй чек от покупки на <a href="http://russellhobbs-promo.ru">russellhobbs-promo</a>, прими участие в акции «Выиграй мечту» и выиграй подарок для себя!<br/><br/>
                    Заранее спасибо,<br/>
                    {from}<br/><br/>
                </div>
