...
class Test extends Component {
    ...
    getRulesScreen() {
        return <div className='test__rules'>
            ...
            <p>Вы можете пройти тест не более 20 раз до начала очередного розыгрыша.</p>
    ...
    getStartScreen() {
        return <div>
            ...
            <small><a href='http://164623.selcdn.com/russell/rules/Istoriya_v_detalyah_rules.pdf' target='_blank'>Условия и правила проведения акции</a></small>
        </div>
    }
    getResultsScreen() {
