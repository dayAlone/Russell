...
class Test extends Component {
    ...
    getRulesScreen() {
        return <div className='test__rules'>
            ...
            <p>За каждый неправильный ответ из базового времени вычитается 5 секунд. За каждый правильный ответ к базовому времени прибавляется 1 секунда.</p>
            ...
            <p>Всего вы можете пройти тест не более 20 раз до начала розыгрыша. </p>
            <p>По итогам игры формируются набрнанные вами баллы. </p>
