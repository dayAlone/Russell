...
class PageConditions extends Component {
    ...
    render() {
        return <div className='page page--collections'>
            ...
            <div className='text'>
                <h2>Условия проведения акции и использования сайта</h2>
            	...
            	<p>1.4. Регистрация —путем входа через аккаунт Пользователя, создаваемый на Сайте путем регистрации на его электронную почту, либо через имеющийся аккаунт Пользователя (социальная сеть ВКОНТАКТЕ или ФЕЙСБУК).
            	</p>
            	...
            	<ul>
            		...
            		<ul>
            			<li>4.1.1. предоставляемые Пользователями и минимально необходимые для регистрации на Сайте: имя, фамилия, адрес электронной почты, остальные данные по желанию;</li>
            	...
            	<p>7. Перед обращением в суд стороны должны соблюсти обязательный досудебный порядок и направить Администрации Сайта соответствующую претензию в письменном виде и на почту <a href='mailto://support@russellhobbs-promo.ru' target='_blank'>support@russellhobbs-promo.ru</a>
            	</p>
            	...
            	<p>12. Пользователь может удалить свой аккаунт и персональные данные на Сайте, написав заявку на <a href='mailto:support@russellhobbs-promo.ru' target='_blank'>support@russellhobbs-promo.ru</a>
                <br/><br/><br/><br/>
            	</p>
