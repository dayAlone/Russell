    ...
    render() {
        return <div className='page page--index'>
            ...
            <div className="text">
                ...
                <p>Потребитель в сердце всего, что мы делаем, всего, что вдохновляет нас делать мир вещей лучше. От чайников и утюгов до техники для приготовления пищи, вся наша продукция предлагает стильное решение сделать быт легче. Мы работаем, думая о людях, создавая приборы, которые делают жизнь дома еще более приятной.</p>
...
 
                ...
                <p>Бренд развивается и никогда не стоит на месте. К 60-летнему юбилею со дня создания первой инновации, компания Russell Hobbs гордится тем, что является маркой №1 в Великобритании, распространяя успех на территории Европы и по всему миру.</p>
                <p><strong>Мы — Russell Hobbs, в сердце Вашего дома.</strong></p>
            </div>
            <PageHistorySlider />
        </div>
