...
            description: 'Вам нравится коллекционировать? А играть? Скоро вы сможете принять участие в нашей игре &laquo;Собери коллекцию&raquo; и выиграть технику Russell Hobbs или скидку на покупку техники Russell Hobbs. Ждем вас здесь с #start#.',
            dateStart: '9.11.2015',
            dateStop: '30.12.2015',
...
            description: 'Что вам больше нравится - дарить или получать подарки на Новый год? Теперь вы легко сможете совместить эти два приятных занятия. С #start# заходите к нам, участвуйте в акции &laquo;В подарок. Для себя&raquo; и делитесь с друзьями желаниями. Ждем вас, осталось совсем недолго!',
